...
<!-- Framework 7 script -->
<script type="application/javascript" src="<?php echo base_url(); ?>asset/mobile/js/framework7.min.js"></script>
<script type="application/javascript" src="<?php echo base_url(); ?>asset/js/material.min.js"></script>
<script type="application/javascript" src="<?php echo base_url(); ?>asset/mobile/js/jquery.timeago-min.js"></script>
...
<script type="application/javascript" src="<?php echo base_url(); ?>asset/mobile/js/welcomescreen.js"></script>
...
<script>
    ...
    /*picture: '<div class="tutorialicon"><img src="asset/images/splashLogo.png"/>'+
    '<span class="load-txt">Welcome To Doolally!</span><div class="progress-bar"><div class="progressbar-infinite"></div></div></div>'*/
    if(localStorageUtil.getLocal('ageGateGone') == null)
    {
        var welcomescreen_slides = [
            {
                id: 'slide0',
                picture: '<div class="new-age-panel"><div class="tutorialicon"><img src="<?php echo base_url();?>asset/images/splashLogo.png"/></div><br>'+
                '<span class="load-txt">Welcome To Doolally!</span><div class="row"><div class="col-10"></div><div class="col-80">' +
                '<p class="sub-age-txt">Are you of legal drinking age?' +
                '</p></div><div class="col-10"></div></div><div class="row">' +
                '<div class="col-5"></div><div class="col-90"><button type="button" class="button button-fill common-app-btn yes-age-btn">Yes</button>' +
                '<button type="button" class="button button-fill common-app-btn no-age-btn">No</button></div><div class="col-5"></div></div></div>'
            }
        ];
    }
    else
