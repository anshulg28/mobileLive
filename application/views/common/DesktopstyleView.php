...
<link rel="icon" type="image/x-icon" sizes="76x76" href="<?php echo base_url();?>asset/images/doolally-app-icon.png"/>
<link rel="apple-touch-icon" type="image/x-icon" sizes="114x114" href="<?php echo base_url();?>asset/images/doolally-app-icon-apple.png"/>
...
<link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>asset/mobile/css/jssocials.css">
<link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>asset/mobile/css/jssocials-theme-minima.css">
<link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>asset/mobile/css/cropper.min.css">
<link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>asset/mobile/css/fullcalendar.min.css">
<link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>asset/css/vex.css">
<link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>asset/css/vex-theme-plain.css">
